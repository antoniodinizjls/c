...
int main() {
    ...
    // Encontrando maior e menor quantidade de repetições
    ...
    // Mostrando os que apareceram 2 vezes ou menos
    cout << "Numeros que apareceram duas vezes ou menos \n";
    for(int v = 0; v < b; v++) {
        if(menos2[v] != 0) {
            cout << menos2[v] << "\n";
        }
